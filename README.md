...
Simply open the HTML file in your browser and follow prompts
...
1. Clone the repo
   ```sh
   git clone https://github.com/bgrinthal/Music-Concerts-API.git
   ```
...
Run application on browser and enter city to search for venue tickets and view weather in that area.
...
Project Link: [https://github.com/bgrinthal/Music-Concerts-API](https://github.com/bgrinthal/Music-Concerts-API)
